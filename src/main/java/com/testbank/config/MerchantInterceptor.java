...
import com.testbank.repository.apikey.ApiKeyDao;
    ...
    public boolean preHandle(HttpServletRequest request,
            HttpServletResponse response,
             Object handler) throws Exception {
                ...
                }else if(keyInDb == null || !apiKey.equals(keyInDb.getValue()) || keyInDb.getStatus() != com.testbank.util.enums.ApiKeyStatus.ACTIVE){
